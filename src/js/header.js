...
function gettextSet (i){
				textSet = [
					{text:"BLACK_ROOM", sphereRadius:120-i, sphereSpace:70-i*0.6, unitTime:150, time:1500},
					{text:"CREATE", sphereRadius:120-i, sphereSpace:70-i*0.6, unitTime:120, time:4000},
					{text:"PERFORMANCE", sphereRadius:120-i, sphereSpace:70-i*0.65, unitTime:100, time:3000},
					{text:"@@@@@@@@", sphereRadius:80 + Math.random()*60-i*0.5, sphereSpace:150-i*0.6, unitTime:100, time:4000},
					{text:"CTPAX", sphereRadius:120-i, sphereSpace:70-i*0.6, unitTime:150, time:3000},
					{text:"ПOГЛOTИT", sphereRadius:130-i, sphereSpace:80-i*0.6, unitTime:50, time:4000},
					{text:"BAC", sphereRadius:140-i, sphereSpace:80-i*0.6, unitTime:150, time:3000},
					{text:"@@@@@@@@", sphereRadius:80 + Math.random()*60-i*0.5, sphereSpace:150-i*0.6, unitTime:100, time:4000},
				]}
